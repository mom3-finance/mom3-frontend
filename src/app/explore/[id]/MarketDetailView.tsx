  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto flex min-h-screen w-full flex-col px-5 pb-28 pt-4 sm:max-w-md">
        ...
        <section className="mt-6 rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_82%_4%,rgba(204,255,0,0.16),rgba(17,18,23,1)_42%)] p-4">
          <div className="flex items-start gap-3">
            <span className={`flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl ${market.color}`}>
              <Icon
                icon={market.icon}
                aria-hidden="true"
                width={31}
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <div>
              <p className="text-sm font-medium text-[#A7A7B7]">Current rate</p>
              <p className="mt-1 text-4xl font-black text-white">{market.primary}</p>
            </div>
            <div className="text-right">
              <p className="text-sm font-medium text-[#A7A7B7]">TVL</p>
              <p className="mt-1 text-3xl font-black text-[#ccff00]">{market.tvl}</p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-4 rounded-[24px] border border-white/10 bg-[#111217] p-4">
          <h2 className="text-base font-black text-white">Before entering</h2>
          <p className="mt-2 text-sm font-medium leading-relaxed text-[#A7A7B7]">
